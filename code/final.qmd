...
sst_clean <- sst |> # data frame
 ...
 select( year, month, surf_temp_c) |> # show only these columns
   filter(
      year == c(2018, 2019, 2020, 2021, 2022, 2023) # show only these years
   ) |> 
   rename(
      mean_monthly_sst = "surf_temp_c" # change name of column 
   )
